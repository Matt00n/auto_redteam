...
class Mastermind:
    ...
    def generate_hypothesis(self, target_files: dict, directive: dict, mechanism_map: str = None, context_mode: str = "raw_code", feedback: str = None, parent_attempt: dict = None, failed_families: list = None) -> str:
        """
        ...
        if "websocket" in focus_lower or "spoofing" in focus_lower or "payload" in focus_lower:
            persona_title = "Network and Protocol Auditor specializing in WebSocket validation bypass"
        elif "automation" in focus_lower or "hid" in focus_lower or "keyboard" in focus_lower or "virtual" in focus_lower:
            ...
            persona_title = "Elite Red-Team Mastermind specializing in logic flaw exploitation"
        ...
        if failed_families:
            ...
            for f in failed_families:
                system_prompt += f"- {f}\n"
            system_prompt += "You must discover and design a completely alternative attack path.\n"
